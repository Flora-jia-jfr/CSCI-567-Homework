...
classifiers = [
    SVC(kernel="linear", C=0.01),  # C controls the penalty term for misclassifying training data
    ...
    SVC(kernel="linear", C=0.5),   # Smaller C means stronger regularization
    # SVC(kernel="rbf", gamma=2, C=0.25),
    # SVC(kernel="rbf", gamma=2, C=0.5),
    # SVC(kernel="rbf", gamma=2, C=0.75),
    # SVC(kernel="rbf", gamma=2, C=1),
    # SVC(kernel="rbf", gamma=2, C=10),
    # SVC(kernel="rbf", gamma=2, C=100),
    ...
    # LogisticRegression(penalty='l2', C=4.0),
    # LogisticRegression(penalty='l2', C=8.0)
]
